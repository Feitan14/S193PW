    ...
    <script>
        ...
        function createUser() {
            Swal.fire({
                title: 'Crear Usuario',
                html: `
                    <input type="text" id="userName" class="swal2-input" placeholder="Nombre" required>
                    <input type="email" id="userEmail" class="swal2-input" placeholder="Correo Electrónico" required>
                    <input type="password" id="userPassword" class="swal2-input" placeholder="Contraseña" required>
                    <select id="userRole" class="swal2-input" required>
        ...
        function editUser(button) {
            ...
            Swal.fire({
                ...
                html: `
                    <input type="text" id="userName" class="swal2-input" placeholder="Nombre" value="${currentData.name}" required>
                    <input type="email" id="userEmail" class="swal2-input" placeholder="Correo Electrónico" value="${currentData.email}" required>
                    <select id="userRole" class="swal2-input" required>
                        <option value="">Seleccione un rol</option>
